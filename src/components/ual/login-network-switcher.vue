    ...
    >
      <template v-slot:label>
        <div class="row items-center justify-between no-wrap">
          ...
          <profile-pic
            v-if="getAccountName && avatar"
            :size="28"
            :icon="getIsGuardian(getAccountName) ? 'mdi-star' : ''"
            iconColor="primary"
      ...
      <q-list dark class="bg-secondary" separator>
        <q-item
          ...
          clickable
          v-close-popup
          @click="$store.dispatch('ual/logout')"
          class="bg-secondary"
        >
        ...
        <q-item
          v-if="getAccountName && getActiveGroup"
          clickable
          v-close-popup
          :to="`/members/${getActiveGroup}/profile/${getAccountName}`"
          class="bg-secondary"
        >
          <q-item-section avatar>
        ...
        <q-item
          ...
          clickable
          v-close-popup
          @click="emitter.emit('showHubDeposits')"
        >
          <q-item-section avatar>
